...
class Application_Model_DbTable_Noticias extends Zend_Db_Table_Abstract {
    ...
    public function del($id) {
     ...
     public function getNoticias() {        
        $select = $this->select()
             ->from(array('e'  => 'hk_noticia'),array('id','id_autor' ,'titulo','noticia', 'date_add'=>'DATE_FORMAT(date_add, "%d/%m/%Y")' , 'date_upd'=>'DATE_FORMAT(date_upd, "%d/%m/%Y")','estatus', 'foto', 'seo_titulo', 'seo_descripcion', 'seo_key'))  
