...
class SolicitudController extends Zend_Controller_Action {
    ...
    public function indexAction(){
     ...
     public function presupuestoAction(){
        ...
        if ($ObjPresupuesto->add($formData)) {
            ...
            $message='El id de su solicitud es: <h3>'.$id.'</h3> con este podra consultar el estado de su solicitud en la pagina web, de igual forma podra cargar el pago correspondiente por el servicio. Tambien puede consultar su solicitud haciendo click en el enlace <a href="http://tirex2021.com/presupuesto/ver/id/'.$id.'" >Consultar</a>';
    ...
    public function auditarAction(){
        ...
        $this->view->modulos = $ObjModulos->fetchAll('estatus=1');
         ...
         if ($this->getRequest()->isPost()) {
            ...
            $message='El id de su solicitud es: <h3>'.$id.'</h3> con este podra consultar el estado de su solicitud en la pagina web, de igual forma podra cargar el pago correspondiente por el servicio. Tambien puede consultar su solicitud haciendo click en el enlace <a href="http://tirex2021.com/auditoria/ver/id/'.$id.'" >Consultar</a>';
    ...
    public function validadorAction(){
        ...
        $this->view->modulos = $ObjModulos->fetchAll('estatus=1');
         ...
         if ($this->getRequest()->isPost()) {
            ...
            $message='El id de su solicitud es: <h3>'.$id.'</h3> con este podra consultar el estado de su solicitud en la pagina web. Tambien puede consultar su solicitud haciendo click en el enlace <a href="http://tirex2021.com/validador/ver/id/'.$id.'" >Consultar</a>';
      ...
      public function muebleAction(){
        ...
        $this->view->modulos = $ObjModulos->fetchAll('estatus=1');
         ...
         if ($this->getRequest()->isPost()) {
            ...
            $message='El id de su solicitud es: <h3>'.$id.'</h3> con este podra consultar el estado de su solicitud en la pagina web, de igual forma podra cargar el pago correspondiente por el servicio. Tambien puede consultar su solicitud haciendo click en el enlace <a href="http://tirex2021.com/mueble/ver/id/'.$id.'" >Consultar</a>';
    ...
    public function inmuebleAction(){
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $message='El id de su solicitud es: <h3>'.$id.'</h3> con este podra consultar el estado de su solicitud en la pagina web, de igual forma podra cargar el pago correspondiente por el servicio. Tambien puede consultar su solicitud haciendo click en el enlace <a href="http://tirex2021.com/inmueble/ver/id/'.$id.'" >Consultar</a>';
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <a target="_blank" href="chronikapp.com"><img  border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="http://tirex2021.com/assets/img/6b1a00785b1ae5703544cc446e5d7505.jpg" class="banner"></a>
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                 ...
                                 <td>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td width="100%" align="center" class="devicewidth">
                                                <img src="http://tirex2021.com/assets/img/7fb4b04d4c764d6b1491dc8a9c9ec4db.png" alt="" border="0" width="100" height="100" style="display:block; border:none; outline:none; text-decoration:none;">
                                             </td>
                                          </tr>
                                          <!-- end of image2 -->
                                          <tr>
                                    ...
                                    <table width="186" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                       <tbody>
                                          ...
                                          <tr>
                                             <td width="100%" align="center" class="devicewidth">
                                                <img src="http://tirex2021.com/assets/img/6d0b8b9ddbc0b962d4852dbfd3ad038d.png" alt="" border="0" width="100" height="100" style="display:block; border:none; outline:none; text-decoration:none;">
                                             </td>
                                          </tr>
                                          <!-- end of image3 -->
                                          <tr>
                                                   ...
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td width="290" height="160" align="center" class="devicewidth">
                                                            <img src="http://tirex2021.com/assets/img/e3586ae6b067234195b742c649d8f030.jpg" alt="" border="0" width="160" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                         </td>
                                                      </tr>
                                                      <!-- Content -->
                                                      <tr>
                                             ...
                                             <td>
                                                ...
                                                <table width="290" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         <td width="290" height="160" align="center" class="devicewidth">
                                                            <img src="http://tirex2021.com/assets/img/074037ad19596ca245729bfa7025b4b5.jpg" alt="" border="0" width="160" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                                         </td>
                                                      </tr>
                                                      <!-- Content -->
                                                      <tr>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td  align="center" class="devicewidth">
                                                   <img src="http://tirex2021.com/assets/archivos/procesadas/logo_apaisado.png" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                                             </td>
                  ...
                  <td style="width: 35%;"></td><td style="width: 15%;"></td>
                     ...
                     <td align="center" height="50" style="font-size:12px; line-height:1px; text-align: left;">
                              ...
                              <a target="_blank" href="http://www.maymi.com.ve">
                                 <img src="http://tirex2021.com/assets/img/logo_maymi.png" alt="" height="20" border="0" style="display:block; border:none; outline:none; text-decoration:none;" class="colimg2">
                              </a>                 
...
<!-- End of seperator -->  
                   ...
                   $headers .= "Bcc: info@tirex2021.com\r\n"; 
