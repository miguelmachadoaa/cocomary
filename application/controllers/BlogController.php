...
class BlogController extends Zend_Controller_Action {
    ...
    public function indexAction(){
       ...
       //icias = $ObjNoticias->getNoticias();
        ...
        $this->view->pagina = $ObjPaginas->fetchRow('grupo="noticias"');
        ...
        $this->view->sliders = $ObjSliders->fetchAll();
         ...
         $meta = array(
            'titulo' => 'Noticias | Tienda Cocomary', 
            'descripcion' => 'Noticias, usos y beneficios de nuestros productos, guia para la ayuda del cuidado de la piel', 
            'key' => 'noticias',
            'imagen' => '',
        ...
        $ObjEtiquetas = new Application_Model_DbTable_Etiquetas();
        // se envia a la vista todos los registros de usuarios
        $this->view->noticia = $ObjNoticias->getNoticiaId($id);

        $noticia=$ObjNoticias->getNoticiaId($id);
        ...
        $meta = array(
            'titulo' => $noticia['seo_titulo'].' -  Tienda Coco Mary ', 
            'descripcion' => strip_tags($noticia['seo_descripcion']), 
            'key' => strip_tags($noticia['seo_key']),
            'imagen' => 'https://www.tiendacocomary.com/'.$noticia['foto'],
            'url'=>'https://www.tiendacocomary.com/blog/ver/id/'.$id,
            'menu'=>'blog'
            );
        ...
        $meta = array(
            'titulo' => 'Noticias relacionadas con '.$id.' -  Tienda Coco Mary ', 
            'descripcion' => strip_tags('Noticias relacionadas con '.$id.' -  Tienda Coco Mary '), 
            'key' => strip_tags($id),
            'imagen' => '',
            'url'=>'https://www.tiendacocomary.com/blog/tags/id/'.$id,
            'menu'=>'blog',
