...
class TopesController extends Zend_Controller_Action {
    ...
    public function init() {
     ...
     public function indexAction(){
        ...
        $this->view->pagina = $ObjPaginas->fetchRow('grupo="topes"');
       ...
       $ObjTopes= new Application_Model_DbTable_Topes();

      
        $this->view->elementos = $ObjTopes->fetchAll('estatus=1');
