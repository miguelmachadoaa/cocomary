...
class ClosetsController extends Zend_Controller_Action {
    ...
    public function init() {
     ...
     public function indexAction(){
        ...
        $this->view->pagina = $ObjPaginas->fetchRow('grupo="closets"');
       ...
       $ObjBanos= new Application_Model_DbTable_Closets();
